    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto">
                <a href="${pageContext.request.contextPath}/admin/recruit/manage" class="btn btn-outline-secondary">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-actions">
                            <span class="badge bg-${app.status == 0 ? 'warning' : (app.status == 1 ? 'info' : (app.status == 2 ? 'danger' : 'success'))}">
                                <c:choose>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="${app.studentId}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="${app.grade}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" rows="4" readonly>${app.reason}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="${app.createdAt}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
