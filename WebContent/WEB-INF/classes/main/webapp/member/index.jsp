                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="text-muted"><a href="${pageContext.request.contextPath}/project?action=list"
                                                            class="text-reset">查看 & 管理申请</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="text-muted"><a href="${pageContext.request.contextPath}/activity?action=myActivities"
                                                            class="text-reset">查看我的报名活动</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <span class="bg-azure text-white avatar"><i
                                                            class="bi bi-file-earmark-person"></i></span>
                                                </div>
                                                <div class="col">
