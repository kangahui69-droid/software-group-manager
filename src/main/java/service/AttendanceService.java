 ...
 * 考勤服务层
 *
 * 服务分层与API化完整计划.md 4.2 AttendanceService 考勤服务
 */
public class AttendanceService {
    ...
    private final AttendanceMakeupDAO attendanceMakeupDAO;
    ...
    public AttendanceService() {
        ...
        this.attendanceMakeupDAO = new AttendanceMakeupDAO();
        this.userDAO = new UserDAO();
    }

    public AttendanceService(AttendanceDAO attendanceDAO, AttendanceMakeupDAO attendanceMakeupDAO, UserDAO userDAO) {
        this.attendanceDAO = attendanceDAO;
        this.attendanceMakeupDAO = attendanceMakeupDAO;
    ...
    private Result validateUserId(Integer userId) {
        ...
        try {
            ...
            return Result.error(500, "用户验证失败: " + e.getMessage());
        }
        return null;
    }
    ...
    private Result validateOperator(Integer operatorId) {
        ...
        try {
            ...
            if (operator == null) {
                return Result.error(404, "操作员不存在");
            }
        } catch (Exception e) {
            return Result.error(500, "操作员验证失败: " + e.getMessage());
        }
        return null;
    }
    ...
    private Result processMakeupApproval(Integer id, Integer operatorId, String targetStatus, String action) throws Exception {
