    ...
    <div class="container-xl">
        <div class="member-hero">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <a href="${pageContext.request.contextPath}/award?action=myAwards" class="back-btn">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="card-design mb-4">
                    ...
                    <div class="card-body-design">
                        <a href="${pageContext.request.contextPath}/award?action=myAwards" class="quick-link">
