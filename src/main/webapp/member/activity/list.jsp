    ...
    <div class="container-xl">
        <div class="member-hero">
            <h1 class="member-hero-title">
                <i class="bi bi-calendar-event me-2"></i>活动报名
            </h1>
            <p class="member-hero-subtitle">查看和管理活动报名</p>
        </div>

        <div class="card-design">
            <div class="card-header-design">
                <h3 class="card-title-design">
                    <i class="bi bi-calendar-plus text-brand"></i>活动功能
                </h3>
            </div>
            <div class="card-body-design">
                <div class="empty-state">
                    ...
                    <p class="empty-state-desc">活动报名功能正在紧张开发中，请耐心等待...</p>
